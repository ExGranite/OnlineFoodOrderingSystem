            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="section-heading">
                        <h6>Breakfast</h6>
                        <h2>Best breakfast for your morning</h2>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="item">
                                <div class='card' style="background-image: url('/foodimage/{{$data->image}}')">
                                    ...
                                    <div class="main-text-button">
                                        <div class="scroll-to-section ok">
                                            <input class="extra" type="number" name="quantity" min="1" value="1" style="width: 60px; background-color: wheat; float: left; height: 35px; text-allign: right; padding-left: 10px; border-radius: 5px;">
